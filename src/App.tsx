...
function AppContent() {
  ...
  const { themeMode, storedTheme, lightTheme, darkTheme, systemTheme } =
    useThemeManager()
  ...
  return (
    <ThemeProvider
      value={{ themeMode, storedTheme, lightTheme, darkTheme, systemTheme }}
    >
      <AuthProvider>
        <Router>
            ...
            <main className="flex-grow">
              ...
              <Routes>
                ...
                <Route
                  path="/signin"
                  element={
                    !currentUser ? <SignIn /> : <Navigate to="/profile" />
                  }
                />
                <Route
                  path="/signup"
                  element={
                    !currentUser ? <SignUp /> : <Navigate to="/profile" />
                  }
                />
                <Route
                  path="/profile"
                  element={
                    currentUser ? <Profile /> : <Navigate to="/signin" />
                  }
                />
                ...
                <Route
                  path="/tech/:feild/:subdomain/:markdownfile"
                  element={<TechArticle />}
                />
